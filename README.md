...
Methodology
Host discovery using Nmap -sn to find live hosts.
Top-1000 TCP ports scan with -sS (when Npcap + Admin) or -sT.
Targeted service/version detection (-sV) on interesting hosts.
Optional: UDP scan for common UDP services and Wireshark packet capture for evidence.
